...
// Page Route
import { RessourcesHumainesRoutingModule } from './ressources-humaines-routing.module';
...
@NgModule({
  declarations: [
    ImporterSalaireComponent,
    ListeSalaireComponent
  ],
  imports: [
    CommonModule,
    RessourcesHumainesRoutingModule,
    SharedModule,
